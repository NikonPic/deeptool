...
__all__ = ['MAX_PIXEL_VAL', 'MEAN', 'STDDEV', 'INPUT_DIM', 'read_dir', 'read_labels', 'MRNetDataset', 'RandomCrop',
           'TriplePrep', 'MiddleCrop', 'Rescale', 'ToTensor', 'Normalize', 'load_mrnet_datasets', 'test_dataset',
           'load_test_batch', 'GaussianBlur', 'TwoCropsTransform', 'load_kneexray_datasets', 'get_loader']
...
def load_mrnet_datasets(args):
    ...
    # tfs = TwoCropsTransform(tfs) if args.model_type == "mocoae" else tfs

    # Create Datasets
    train_dataset = MRNetDataset(args, mode="train", transform=tfs)
    ...
    valid_dataset = MRNetDataset(args, mode="valid", transform=tfs)
