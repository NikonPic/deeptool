...
__all__ = ['MAX_PIXEL_VAL', 'MEAN', 'STDDEV', 'INPUT_DIM', 'MRNetDataset', 'RandomCrop', 'TriplePrep', 'MiddleCrop',
           'Rescale', 'ToTensor', 'Normalize', 'load_mrnet_datasets', 'test_dataset', 'load_test_batch',
           'load_kneexray_datasets', 'get_loader']
...
def get_loader(args, root_dir):
    ...
    dataset = dset.ImageFolder(
        ...
        transform=transforms.Compose(
            [
                transforms.Resize(args.pic_size),
                transforms.CenterCrop(args.pic_size),
                transforms.ToTensor(),
